...
has caller => (
  is => 'rw',
  isa => $CallerRole, # ConsumerOf['Paws::Net::CallerRole'], 
  lazy => 1,
  default => sub { 
...
has credentials => (
  is => 'rw',
  isa => $Credential, # ConsumerOf['Paws::Credential'], 
  lazy => 1,
  default => sub {
